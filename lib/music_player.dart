    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            CircleAvatar(
              backgroundImage: widget.songInfo.albumArtwork==null ? const AssetImage('assets/images/music_gradient.jpg') : AssetImage(widget.songInfo.albumArtwork),
              radius: 95,
            ),
            Container(
            ...
            Container(
              ...
              child: Text(widget.songInfo.artist, style: const TextStyle(color: Colors.grey, fontSize: 12.5, fontWeight: FontWeight.w500),),
            ),
            Slider(
